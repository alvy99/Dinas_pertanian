...
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/assets/styles/events.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/assets/styles/events_responsive.css">
...
<div class="super_container">
  ...
  <div style="padding-top:450px">
    ...
    <img src="<?php echo base_url() ?>assets/assets/images/ss2.png" width="100%" height="100%" style="position:absolute" class="img-responsive" data-speed="0.8"></div> -->
    <header class="header">
      <div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
                      <nav class="main_nav">
                        <ul>
                          <li class=""><a style="color:white" href="<?php echo base_url("home") ?>">Home</a></li>
  ...
  <br>
  <br>
  <h2 style="text-align: center;"><strong>LAPORAN DATA PETERNAKAN</strong></h2>
  <br>
  <div style="margin-left:60px">
    <form action="<?php echo site_url('laporan_grafik_peternakan/cari')?>" method="post" >
    ...
    <div class="footer" style="background-color: #005B8F">
      <div class="container">  
        <div class="row">
          ...
          <!-- Footer Column -->
          <div class="footer_col" style="padding-top:40px">
      ...
      <div class="container" style="background-color: #005B8F">
        <div class="row">
          <div class="col">
                ...
                <h6 style="color:white">Copyright &copy;<script>document.write(new Date().getFullYear());</script> Ketersediaan Bahan Pangan</h6>
              </div>
              </div>
            </div>
        </div>
