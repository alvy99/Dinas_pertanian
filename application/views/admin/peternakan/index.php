				...
				<tbody>
					<?php foreach ($peternakan as $key => $value) : ?>
						<tr>
							...
							<td>
							<a href="<?php echo base_url("admin/peternakan/edit_peternakan/" . $value['nomor']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
							<a href="<?php echo base_url("admin/peternakan/hapus_peternakan/" . $value['nomor']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
					<?php endforeach ?>
				</tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo base_url() . 'admin/peternakan/tambah_peternakan' ?>" method="post">
