      ...
      <div class="table-responsive">
        <table id="example2" class="table table-bordered table-hover table-striped">
          <thead>
            <tr>
                  ...
                  <th style="text-align:center">Harga Satuan(Rp/Kg)</th>
                  ...
                  <th style="text-align:center">Asal Ikan</th>
                        ...
                        <a href="<?php echo base_url("admin/perikanan/edit_perikanan/" . $value['nomor']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
										<a href="<?php echo base_url("admin/perikanan/hapus_perikanan/" . $value['nomor']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
  												</td>
  											</tr>
  										<?php endforeach ?>
  									</tbody>
  		...
  		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="<?php echo site_url() . 'admin/perikanan/tambah_perikanan' ?>" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah(Kg)" value="<?php echo set_value('jumlah'); ?>">
