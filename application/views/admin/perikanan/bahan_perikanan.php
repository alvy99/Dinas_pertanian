<div class="content-wrapper">
        ...
        <div class="row">
            ...
            <table style="width:355px" id="example2" class="table table-bordered table-hover table-striped">
                    ...
                    <?php foreach ($jenis_ikan as $key => $value) : ?>
						...
						<td>
              <a href="<?php echo base_url("admin/bahan_perikanan/edit_bahan/" . $value['id_jenis']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
							<a href="<?php echo site_url("admin/bahan_perikanan/hapus_bahan/" . $value['id_jenis']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
                <?php endforeach ?>
					</tbody>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <?php echo form_open_multipart('admin/bahan_perikanan/tambah_bahan') ?>
