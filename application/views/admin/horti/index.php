				...
				<table id="example2" class="table table-bordered table-hover table-striped">
					<thead>
						<tr>
							...
							<th style="text-align:center">Haga(Rp/Kg)</th>
					...
					<tbody>
						...
						<td>
							<a href="<?php echo base_url("admin/horti/edit_horti/" . $value['nomor']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
							<a href="<?php echo base_url("admin/horti/hapus_horti/" . $value['nomor']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
						<?php endforeach ?>
					</tbody>
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="<?php echo site_url() . 'admin/horti/tambah_horti' ?>" method="post">
