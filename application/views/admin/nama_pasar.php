              ...
              <tbody>
                <?php foreach ($pasar as $key => $value) : ?>
                  <tr>
                   ...
                   <td>
                    <a href="<?php echo base_url("admin/nama_pasar/edit_pasar/" . $value['id_pasar']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                    <a href="<?php echo site_url("admin/nama_pasar/hapus_pasar/" . $value['id_pasar']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <?php echo form_open_multipart('admin/nama_pasar/tambah_pasar') ?>
