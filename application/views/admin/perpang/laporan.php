<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Laporan Pertanian dan Pangan</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="admin/overview">Home</a></li>
            <li class="breadcrumb-item active">Laporan</li>
            <li class="breadcrumb-item active">Laporan Pertanian dan Pangan</li>
          </ol>
        </div>
      </div>
    </div>
    <br>
    <form action="<?php echo site_url('admin/laporan_perpang/cari')?>" method="post" >
