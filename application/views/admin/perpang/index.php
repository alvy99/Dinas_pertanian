				...
				<table id="example2" class="table table-bordered table-hover table-striped">
					<thead>
						<tr>
							...
							<th width="5px">Harga(Rp)</th>
							<th width="3px">Stok</th>
							...
							<tr>
								...
								<td class="text-right py-0 align-middle">
									<div class="btn-group btn-group-sm">
										<a href="<?php echo base_url("admin/perpang/edit_perpang/" . $value['nomor']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
										<a href="<?php echo base_url("admin/perpang/hapus_perpang/" . $value['nomor']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
									</div>
								</td>
							</tr>
						<?php endforeach ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo base_url() . 'admin/perpang/tambah_perpang' ?>" method="post">
