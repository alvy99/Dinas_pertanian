   ...
   <div class="modal-body">
        ...
        <?php endforeach ?>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah" value="<?= $perikanan['jumlah'] ?>">
            ...
            <select class="form-control" id="keterangan" name="keterangan">
              <option selected>Pilih Keterangan</option>
                ...
                <option value="Ptng">Ptng</option>
         		...
         		<a class="btn btn-info " href="<?= base_url('superadmin/Perikanan/') ?>">Kembali</a>
