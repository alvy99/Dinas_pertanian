<div class="content-wrapper">
  ...
  <div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a class="dropdown-item" href="<?php echo base_url() ?>superadmin/perikanan/excel/<?php echo $rs_search['tanggal_awal']?>/<?php echo $rs_search['tanggal_akhir']?>/<?php echo $rs_search['id_pasar']?>/<?php echo $rs_search['id_pedagang']?>">EXCEL</a>
				<a class="dropdown-item" href="<?php echo base_url() ?>superadmin/perikanan/laporan_pdf/<?php echo $rs_search['tanggal_awal']?>/<?php echo $rs_search['tanggal_akhir']?>/<?php echo $rs_search['id_pasar']?>/<?php echo $rs_search['id_pedagang']?>">PDF</a>
			</div>
		</div>
            </div>
              </div>
