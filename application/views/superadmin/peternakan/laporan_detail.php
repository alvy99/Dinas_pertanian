    ...
    <div style="float:right">
        <div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a class="dropdown-item" href="<?php echo base_url() ?>superadmin/peternakan/excel/<?php echo $rs_search['tanggal_awal']?>/<?php echo $rs_search['tanggal_akhir']?>/<?php echo $rs_search['id_pasar']?>">EXCEL</a>
				<a class="dropdown-item" href="<?php echo base_url() ?>superadmin/peternakan/laporan_pdf/<?php echo $rs_search['tanggal_awal']?>/<?php echo $rs_search['tanggal_akhir']?>/<?php echo $rs_search['id_pasar']?>">PDF</a>
			</div>
		</div>
            </div>
              </div>
