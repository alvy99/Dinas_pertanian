<div class="content-wrapper">
            ...
            <div class="card-body">
				<table style="width:348px" id="example2" class="table table-bordered table-hover table-striped">
                    ...
                    <?php foreach ($bahan_horti as $key => $value) : ?>
						...
						<td>
              <a href="<?php echo base_url("superadmin/bahan_horti/edit_bahan/" . $value['id_bahan']) ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
							<a href="<?php echo site_url("superadmin/bahan_horti/hapus_bahan/" . $value['id_bahan']) ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
                <?php endforeach ?>
					</tbody>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <?php echo form_open_multipart('superadmin/bahan_horti/tambah_bahan') ?>
