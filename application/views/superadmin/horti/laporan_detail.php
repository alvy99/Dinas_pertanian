  ...
  <section class="content-header">
    ...
    <br>
     <div style="margin-left:400px">
       <label><h5>DATA INFORMASI HARGA </h5></label>
     </div>
    ...
    <div style="float:right">
        <div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a class="dropdown-item" href="<?php echo base_url() ?>superadmin/horti/excel/<?php echo $rs_search['tanggal_awal']?>/<?php echo $rs_search['tanggal_akhir']?>/<?php echo $rs_search['id_pasar']?>">EXCEL</a>
				<a class="dropdown-item" href="<?php echo base_url() ?>superadmin/horti/laporan_pdf/<?php echo $rs_search['tanggal_awal']?>/<?php echo $rs_search['tanggal_akhir']?>/<?php echo $rs_search['id_pasar']?>">PDF</a>
			</div>
		</div>
            </div>
  </div>
      ...
      <div class="table-responsive">
        <table style="width:700px" align="center" id="example2" class="table table-bordered table-hover table-striped" >
          <thead>
            <tr>
                <th width="1px">No</th>
