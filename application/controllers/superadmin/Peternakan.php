...
class Peternakan extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('superadmin/peternakan/index', $data);
	...
	public function tambah_peternakan()
	{
		...
		if ($this->form_validation->run() ==  FALSE) {
			...
			redirect('superadmin/Peternakan');
		}
	} 
	public function edit_peternakan($id)
	{
		...
		if ($this->form_validation->run() ==  FALSE) {
			$this->load->view("layouts2/header");
			$this->load->view('superadmin/peternakan/edit', $data);
			$this->load->view("layouts2/footer");
		} else {
	...
	public function laporan()
	{
		...
		$this->load->view("layouts2/header");
		$this->load->view('superadmin/peternakan/laporan', $data);
		$this->load->view("layouts2/footer");
	...
	public function laporan_pdf($tanggal_awal,$tanggal_akhir,$id_pasar)
		...
		$this->pdf->load_view('superadmin/peternakan/laporan_pdf', $data);
	}
