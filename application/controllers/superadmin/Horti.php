...
class Horti extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('superadmin/horti/index', $data);
	...
	public function edit_horti($id)
	{
		...
		if ($this->form_validation->run() ==  FALSE) {
			...
			$this->load->view('superadmin/horti/edit', $data);
	...
	$data['rs_search'] = $search;
		...
		$this->pdf->load_view('superadmin/horti/laporan_pdf', $data);
	}
	public function laporan()
	{
		...
		$data = array(
				...
				// 'sum_jumlah'	=> $this->model_horti->get_sum(),
				// 'avg_jumlah'	=> $this->model_horti->get_avg(),
		...
		$this->load->view("layouts2/header");
		$this->load->view('superadmin/horti/laporan', $data);
		$this->load->view("layouts2/footer");
