...
class Laporan_perpang extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('superadmin/perpang/laporan', $data, FALSA);
	}
	...
	public function detail()
	{
		...
		if (empty($data['hasil'])) {
			...
			redirect('superadmin/perpang/laporan');
		}
		...
		$this->load->view('superadmin/perpang/laporan_detail', $data);
	...
	public function cari()
	{
        ...
        redirect("superadmin/Laporan_perpang/detail");		
	}
}