...
class Laporan_peternakan extends CI_Controller
{
	...
	{
		$data['data'] =$this->db->get('peternakan')->result();
		$this->load->view('superadmin/peternakan/laporan', $data, FALSA);
	}
	...
	public function detail()
	{
		...
		if (empty($data['hasil'])) {
			...
			redirect('superadmin/peternakan/laporan');
		}
		$data['rs_search'] = $search;
		$count_data = count($data['hasil']);
		$jumlah_harga= $this->model_laporan_peternakan->get_jumlah_harga($search);
		...
		$this->load->view('superadmin/peternakan/laporan_detail', $data);
	...
	public function cari()
	{
        ...
        redirect("superadmin/Laporan_peternakan/detail");		
	}
}