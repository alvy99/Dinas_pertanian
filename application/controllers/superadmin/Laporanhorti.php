...
class Laporanhorti extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('superadmin/horti/laporan', $data, FALSA);
	}
	...
	public function detail()
	{
		...
		if (empty($data['hasil'])) {
			...
			redirect('superadmin/horti/laporan');
		}
		...
		$this->load->view('superadmin/horti/laporan_detail', $data);
	...
	public function cari()
	{
        ...
        redirect("superadmin/Laporanhorti/detail");		
	}
}