...
class Laporan extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('superadmin/perikanan/laporan', $data, FALSA);
	}
	...
	public function detail()
	{
		...
		if (empty($data['hasil'])) {
			...
			redirect('superadmin/perikanan/laporan');
		}
		...
		$this->load->view('superadmin/perikanan/laporan_detail', $data);
	...
	public function cari()
	{
        ...
        redirect("superadmin/Laporan/detail");		
	}
