...
class Laporan_grafik_perikanan extends CI_Controller
{
	...
	
	{
        ...
        $this->load->model("model_laporan_grafik_perikanan");
...
public function index()
	{
		$data = array(
	    'nama_pasar'	=> $this->model_laporan_grafik_perikanan->get_nama_pasar(),
        'nama_pedagang'   => $this->model_laporan_grafik_perikanan->get_nama_pedagang(),
        );
		// echo "<pre>";print_r($data['nama_pasar']);die;
		$this->load->view('frontend/laporan_grafik_perikanan', $data);
    }
    public function detail()
	{
		...
		$data['hasil'] = $this->model_grafik_perikanan->get_data($search);
		if (empty($data['hasil'])) {
		...
		$jumlah_harga= $this->model_grafik_perikanan->get_jumlah_harga($search);
		...
		$this->load->view('grafik_perikanan', $data);
    ...
    public function cari()
	{
		...
		redirect("Laporan_grafik_perikanan/detail");
    }
	}