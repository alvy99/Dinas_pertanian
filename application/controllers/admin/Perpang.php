...
class Perpang extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/perpang/index', $data);
	...
	public function edit_perpang($id)
	{
		...
		if ($this->form_validation->run() ==  FALSE) {
			$this->load->view("layouts/header");
			$this->load->view('admin/perpang/edit', $data);
			$this->load->view("layouts/footer");
		} else {
	...
	public function laporan_pdf($tanggal_awal,$tanggal_akhir,$id_pasar)
	{
		...
		$this->pdf->load_view('admin/perpang/laporan_pdf', $data);
	}
		...
		public function laporan()
	{
		...
		$data = array(
				...
				// 'sum_jumlah'	=> $this->model_perpang->get_sum(),
				// 'avg_jumlah'	=> $this->model_perpang->get_avg(),
		...
		$this->load->view("layouts/header");
		$this->load->view('admin/perpang/laporan', $data);
		$this->load->view("layouts/footer");
