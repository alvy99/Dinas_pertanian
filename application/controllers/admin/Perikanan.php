...
class Perikanan  extends CI_Controller
{
		...
		public function edit_perikanan($id)
	{
		...
		if ($this->form_validation->run() ==  FALSE) {
			$this->load->view("layouts/header");
			$this->load->view('admin/perikanan/edit', $data);
			$this->load->view("layouts/footer");
		} else {
    ...
    $this->pdf->load_view("admin/perikanan/laporan_pdf", $data);
	}   
	// function getpasar(){
	// 	$params = $this->session->userdata('sektor') == 'PKN';
	// 	$request = $this->model_perikanan->getpasar_model($params);
	...
	public function laporan()
	{
		...
		$data = array(
				...
				// 'sum_jumlah'	=> $this->model_perikanan->get_sum(),
				// 'avg_jumlah'	=> $this->model_perikanan->get_avg(),
		...
		$this->load->view("layouts/header");
		$this->load->view('admin/perikanan/laporan', $data);
		$this->load->view("layouts/footer");
