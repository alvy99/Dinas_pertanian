...
class Laporan_peternakan extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/peternakan/laporan', $data, FALSA);
	}
	...
	public function detail()
	{
		...
		if (empty($data['hasil'])) {
			...
			redirect('admin/peternakan/laporan');
		}
		...
		$this->load->view('admin/peternakan/laporan_detail', $data);
	...
	public function cari()
	{
        ...
        redirect("admin/Laporan_peternakan/detail");		
	}
}